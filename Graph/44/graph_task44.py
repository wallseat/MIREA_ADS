...
def task(graph: Graph) -> None:
    ...
    adjunction_vertices = set()
    adjunction_vertices.update([v for tup in bridges for v in tup])

    print("Точки сочленения графа: " + ", ".join([str(v) for v in adjunction_vertices]))
