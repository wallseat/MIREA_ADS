...
if __name__ == "__main__":
    ...
    print(f"Дерево А в прямом порядке: {tree_a.traverse_preorder()}, Высота {tree_a.height()}")
    print(f"Дерево B в симметричном порядке: {tree_b.traverse_inorder()}, Высота {tree_b.height()}")
